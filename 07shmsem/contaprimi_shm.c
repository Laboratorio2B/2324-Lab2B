...
// il genitore attende la terminazione dei figli con waitpid
// e successivamente somma i valori restituiti dai figli
...
int main(int argc,char *argv[])
{
  ...
  for(int i=0; i<p; i++) {
    ...
    fprintf(stderr,"Mi metto in attesa del processo: %d\n", salvapid[i]);
